...
const Profile = ({doctorData}) => {
    ...
    const addQualification = e => {
        ...
        addItem('qualifications', {
            startingDate: '', endingDate: '', degree: 'PHD', university: 'Springfield Medical College',
        });
    };
    ...
    const addExperience = e => {
        ...
        addItem('experiences', {
            startingDate: '', endingDate: '', position: 'Senior Surgeon', hospital: 'Cleveland Medical',
        });
    };
    ...
    return (
        <div>
            <h2 className="text-headingColor font-bold text-[24px] leading-0 mb-10">
                Profile Information
            </h2>
            ...
            <form>
                ...
                { formData.photo && 
                    ...
                    <div className="relative w-[130px] h-[50px]">
                        ...
                        />
                        <label htmlFor="customFile" className="absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semifold rounded-lg truncate cursor-pointer">
                            Update Photo
                        </label>
                    </div>
