                        ...
                        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                            ...
                            <div>
                                <div className="lg:w-[570px]">
                                    ...
                                    <p className="text__para">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo vel eligendi, hic iusto consequatur ipsam molestias ullam quidem ea debitis reprehenderit, voluptates labore qui a nam illum consectetur pariatur? Tempora?
                                    </p>
                        ...
                        <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                            ...
                            <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="w-5 h-5 lg:w-[34px] 1g:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px] lg:py-3 lg:px-[9px]">
                ...
                <div className="container">
                    <div className="flex justify-between gap-[50px] lg:gap-0">
                        ...
                        <div className="w-full md:w-1/2">
                            <h2 className="heading">
                                Most questiond by our beloved patients.
                            </h2>
                            <FaqList />
